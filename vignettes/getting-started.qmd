...
For the full clone-to-working walkthrough on a new machine, including the
bootstrap order when `boosterpak` is not installed yet, see
`vignette("restoring-a-project")`.
